...
class SettingsDialogFragment : DialogFragment() {
    ...
    private fun setupDabSettings() {
        ...
        switchDeezerDab.setOnCheckedChangeListener { _, isChecked ->
            ...
            if (callback?.getCurrentRadioMode() == FrequencyScaleView.RadioMode.DAB) {
    ...
    private fun setupGeneralSettings() {
        ...
        textTickSoundVolumeValue.text = "${viewModel.state.value.tickSoundVolume}%"
    ...
    private fun setupDeezerCacheSettings() {
        ...
        dialogView.findViewById<View>(R.id.btnClearDeezerCache).setOnClickListener {
            AlertDialog.Builder(requireContext())
                ...
                .setMessage("Möchten Sie den gesamten Deezer-Cache löschen?")
                .setPositiveButton(R.string.delete) { _, _ ->
    ...
    private fun setupAppSettings() {
        ...
        val animationOptions = arrayOf("Keine", "Slide", "Fade")
