    ...
    private void cmdReadRds() {
        ...
        try {
            ...
            if (psData != null && psData.length > 0) {
                String ps = at.planqton.fytfm.rds.RdsCharset.decode(psData).trim();
        ...
        try {
            ...
            if (ps != null && ps.length > 0) {
                ...
                log("getPs() string: '" + at.planqton.fytfm.rds.RdsCharset.decode(ps).trim() + "'");
            } else {
        ...
        try {
            ...
            if (textData != null && textData.length > 0) {
                ...
                log("Text string: '" + at.planqton.fytfm.rds.RdsCharset.decode(textData).trim() + "'");
            } else {
        ...
        try {
            ...
            if (rt != null && rt.length > 0) {
                ...
                log("getLrText() string: '" + at.planqton.fytfm.rds.RdsCharset.decode(rt).trim() + "'");
            } else {
    ...
    private void dumpBundle(String name, Bundle bundle) {
        ...
        for (String key : bundle.keySet()) {
            ...
            if (value instanceof byte[]) {
                ...
                String asString = at.planqton.fytfm.rds.RdsCharset.decode(bytes).trim();
        ...
        for (float freq : testFreqs) {
            ...
            try {
                ...
                if (result == 0) {
                    byte[] psData = outBundle.getByteArray("PSname");
                    if (psData != null && psData.length > 0) {
                        ps = at.planqton.fytfm.rds.RdsCharset.decode(psData).trim();
                    }
                }
            } catch (Throwable e) {
                // ignore
