...
class SyuRadioService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        Toast.makeText(this, getString(R.string.syu_radio_service_started), Toast.LENGTH_SHORT).show()
    ...
    override fun onBind(intent: Intent?): IBinder? {
        ...
        Toast.makeText(this, getString(R.string.syu_radio_service_bound), Toast.LENGTH_SHORT).show()
