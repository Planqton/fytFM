    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        when (keyEvent.keyCode) {
            KeyEvent.KEYCODE_MEDIA_NEXT -> {
                ...
                context?.let { Toast.makeText(it, it.getString(R.string.media_button_next), Toast.LENGTH_SHORT).show() }
                // TODO: Callback an MainActivity
            }
            KeyEvent.KEYCODE_MEDIA_PREVIOUS -> {
                Log.i(TAG, "PREVIOUS pressed")
                context?.let { Toast.makeText(it, it.getString(R.string.media_button_prev), Toast.LENGTH_SHORT).show() }
                // TODO: Callback an MainActivity
            }
            ...
            KeyEvent.KEYCODE_HEADSETHOOK -> {
                ...
                context?.let { Toast.makeText(it, it.getString(R.string.media_button_play_pause), Toast.LENGTH_SHORT).show() }
                // TODO: Callback an MainActivity
            }
            else -> {
